  ...
  return (
    <section className='ads' >
      ...
      <div className="header">
          <h1 className='ads_heading' data-aos="fade-right">Elevate Your Interiors</h1>
          <Link className='aboutLink' to='/services' data-aos="fade-left">Services</Link>
        </div>
      <div className="line"></div>
      <h2 className='ads_sub' data-aos="fade-left">Designing Interiors That Leave a Lasting Impression</h2>
       ...
       <div className="list">
         ...
         <ul className='lists'  data-aos="fade-left" >
         ...
         <ul className='lists'  data-aos="fade-right">
