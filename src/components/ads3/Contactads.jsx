  ...
  return (
    <div className="contactads">
        ...
        <div className="header">
          <h1 className='aaHeading'  data-aos="fade-right">Get in Touch</h1>
          <Link className='aboutLink' to='/contact'  data-aos="fade-left">Contact</Link>
        </div>
        <div className="line"></div>
      <h2 className='heading_two'  data-aos="fade-right">Building Relationships, One Conversation at a Time</h2>
        </div>
       <div className="desc">
        ...
        <div className="cont">
        <h1 className='descHeading'  data-aos="fade-right">Have a project in mind</h1>
